...
// Release 2.35.0: reliable OTA touch flow, warehouse details, and equipment picker.
...
async function firmware(request, env, grantKind) {
  ...
  try {
    const data = await decryptFirmware(env, grantKind === "install" ? "tamapoke-2.35.0-merged.bin.enc" : "tamapoke-2.35.0-app.bin.enc");
