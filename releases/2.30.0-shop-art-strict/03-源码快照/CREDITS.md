...
| **Shop item icon source shapes** | [OpenMoji](https://openmoji.org/) (CC BY-SA 4.0) | Object silhouettes adapted, recolored and pixel-quantized for the shop, inventory and item detail UI |
